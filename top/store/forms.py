...
class OrderForm(BulmaMixin, forms.ModelForm):
    address = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Напишите адрес доставки'}))
    phone = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Напишите номер телефона'}))
